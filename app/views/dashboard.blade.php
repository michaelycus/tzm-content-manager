						...
						<div ng-app="commentApp" ng-controller="videoCommentController">
							...
							<div class="comment">
								...
								<div class="comment-body">
									<form id="leave-comment-form" class="comment-text no-padding no-border" ng-submit="submitComment()" ng-init="commentData.video_id=0">
							...
							<div class="comment" ng-hide="loading" ng-repeat="comment in comments | limitTo: -10 | orderBy: 'id':true">
								...
								<div ng-show="comment.reply_to == 0">
									...
									<div class="comment-body" ng-show="$index == replyTo">
										<form class="comment-text no-padding no-border" ng-submit="submitReply(comment.id)" ng-init="commentData.video_id=0">
